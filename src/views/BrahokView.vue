<template>
  <div class="max-w-6xl mx-auto p-6 space-y-12">
    ...
    <section class="bg-yellow-50 p-6 rounded-lg shadow-md flex flex-col md:flex-row items-center gap-6 mt-12">
      <img
        src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Tulip_-_floriade_canberra.jpg/800px-Tulip_-_floriade_canberra.jpg"
        alt="Tulip"
...
const flowers = ref([
  {
    ...
    img: 'https://cdn.pixabay.com/photo/2016/02/19/11/19/rose-1209814_1280.jpg',
    category: 'Popular',
    price: 10,
  },
  {
    ...
    img: 'https://cdn.pixabay.com/photo/2016/06/24/10/47/sunflower-1473017_1280.jpg',
    category: 'Seasonal',
    price: 8,
  },
  {
    ...
    img: 'https://cdn.pixabay.com/photo/2018/06/08/18/00/lavender-3463679_1280.jpg',
    category: 'Popular',
    price: 12,
  },
  {
    ...
    img: 'https://cdn.pixabay.com/photo/2017/04/06/13/50/orchid-2202720_1280.jpg',
    category: 'Tropical',
    price: 15,
  },
  {
    ...
    img: 'https://cdn.pixabay.com/photo/2017/01/20/00/30/plumeria-1992204_1280.jpg',
    category: 'Tropical',
    price: 9,
  },
  {
    ...
    img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Tulip_-_floriade_canberra.jpg/800px-Tulip_-_floriade_canberra.jpg',
    category: 'Seasonal',
    price: 15,
  },
])
